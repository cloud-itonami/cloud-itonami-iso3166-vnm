(ns marketentry.store
  "SSoT for the VNM market-entry compliance actor, behind a `Store`
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Systems VN" :portal "muasamcong"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-vn-entity? true :has-vn-entity? true
             :requires-mst? true :mst-verified? true
             :drafted? false :submitted? false
             :jurisdiction "VNM" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "muasamcong"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-vn-entity? true :has-vn-entity? true
             :requires-mst? true :mst-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Minami Systems" :portal "muasamcong"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "VNM" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Export" :portal "muasamcong"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-vn-entity? true :has-vn-entity? false
             :requires-mst? true :mst-verified? true
             :drafted? false :submitted? false
             :jurisdiction "VNM" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistics" :portal "muasamcong"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-vn-entity? true :has-vn-entity? true
             :requires-mst? true :mst-verified? false
             :drafted? false :submitted? false
             :jurisdiction "VNM" :status :intake}
    "eng-6" {:id "eng-6" :operator "Chuo Civic Tech" :portal "muasamcong"
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               requires-vn-entity? has-vn-entity?
                               requires-mst? mst-verified?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? requires-vn-entity?)  (assoc :engagement/requires-vn-entity? requires-vn-entity?)
    (some? has-vn-entity?)       (assoc :engagement/has-vn-entity? has-vn-entity?)
    (some? requires-mst?)    (assoc :engagement/requires-mst? requires-mst?)
    (some? mst-verified?)    (assoc :engagement/mst-verified? mst-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/requires-vn-entity? :engagement/has-vn-entity?
   :engagement/requires-mst? :engagement/mst-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :requires-vn-entity? (boolean (:engagement/requires-vn-entity? m))
     :has-vn-entity? (boolean (:engagement/has-vn-entity? m))
     :requires-mst? (boolean (:engagement/requires-mst? m))
     :mst-verified? (boolean (:engagement/mst-verified? m))
