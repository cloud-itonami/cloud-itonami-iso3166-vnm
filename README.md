# cloud-itonami-iso3166-vnm

Open ISO 3166 Blueprint for **VNM**: Vietnam.
...
tax registration, and local-content rules in Vietnam, so the operator
...
- **Not the government of Vietnam.** See
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official source and route final filings to Vietnamese-licensed counsel
...
(ISO 3166 `VNM`). Required capabilities:
